...
=item B<rrd_client_is_connected(rrd_client_t *client, const char *daemon_addr)>
...
=item B<rrd_client_is_any_connected(rrd_client_t *client)>
...
=item B<rrd_client_flush_if_daemon(rrd_client_t *client, const char *daemon_addr, const char *filename)>
