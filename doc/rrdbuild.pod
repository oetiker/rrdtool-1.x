...
Or if you run tcsh:
 ...
 set INSTALL_DIR=/usr/local/rrdtool-1.2.24
...
could be that they are installed as B<gtar> and B<gmake> on your system.
 ...
 wget http://oss.oetiker.ch/rrdtool/pub/rrdtool-1.2.24.tar.gz
 tar zxf rrdtool-1.2.24.tar.gz
 cd rrdtool-1.2.24
