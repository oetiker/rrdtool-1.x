...
Once you have decided. Save the two locations into environment variables.
 ...
 INSTALL_DIR=/opt/rrdtool-1.11.0
...
pre-installed.
 ...
 wget https://github.com/oetiker/rrdtool-1.x/releases/download/v1.11.0/rrdtool-1.11.0.tar.gz
 gunzip -c rrdtool-1.11.0.tar.gz | tar xf -
 cd rrdtool-1.11.0
