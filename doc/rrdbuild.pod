...
Once you have decided. Save the two locations into environment variables.
 ...
 INSTALL_DIR=/usr/local/rrdtool-1.3.3
...
pre-installed. 
 ...
 wget http://oss.oetiker.ch/rrdtool/pub/rrdtool-1.3.3.tar.gz
 gunzip -c rrdtool-1.3.3.tar.gz | tar xf -
 cd rrdtool-1.3.3
