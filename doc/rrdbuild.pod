...
Once you have decided. Save the two locations into environment variables.
 ...
 INSTALL_DIR=/usr/local/rrdtool-1.3rc7
...
pre-installed. 
 ...
 wget http://oss.oetiker.ch/rrdtool/pub/rrdtool-1.3rc7.tar.gz
 gunzip -c rrdtool-1.3rc7.tar.gz | tar xf -
 cd rrdtool-1.3rc7
