...
Depending on the shell you are using, you can do either (bash,zsh):
 ...
 INSTALL_DIR=/usr/local/rrdtool-1.2.25

Or if you run tcsh:

 set BUILD_DIR=/tmp/rrdbuild
 set INSTALL_DIR=/usr/local/rrdtool-1.2.25
...
could be that they are installed as B<gtar> and B<gmake> on your system.
 ...
 wget http://oss.oetiker.ch/rrdtool/pub/rrdtool-1.2.25.tar.gz
 tar zxf rrdtool-1.2.25.tar.gz
 cd rrdtool-1.2.25
